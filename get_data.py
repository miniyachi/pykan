...
# def clear_cache():
#     # Get the cache directory for OpenML
#     cache_directory = openml.config.cache_directory

#     # Define the path to the dataset you want to clear
#     dataset_id = 41166
#     dataset_cache_path = os.path.join(cache_directory, 'org/openml/www/datasets', str(dataset_id))
